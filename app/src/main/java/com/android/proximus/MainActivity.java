        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            switch (which){
                ...
                case 3:
                    ...
                    Toast.makeText(MainActivity.this,R.string.select_video_warning,Toast.LENGTH_LONG).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK){
            ...
            if (requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST){
                ...
                Log.i(LOG_TAG,"Media Uri: "+mMediaUri);
                if (requestCode == PICK_VIDEO_REQUEST){
                    ...
                    try {
                        ...
                        Toast.makeText(MainActivity.this, R.string.file_picked_error,Toast.LENGTH_LONG).show();
                        return;
                    ...
                    if (fileSize >= FILE_SIZE_LIMIT){
                        Toast.makeText(MainActivity.this,R.string.select_video_error,Toast.LENGTH_LONG).show();
                        return;
                    }
                }
            }
            ...
            Intent reciepientsIntent = new Intent(MainActivity.this,RecipientsActivity.class);
            reciepientsIntent.setData(mMediaUri);
            ...
            reciepientsIntent.putExtra(ParseConstants.KEY_FILE_TYPE, fileType);
            startActivity(reciepientsIntent);
